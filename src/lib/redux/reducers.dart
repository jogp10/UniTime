...
AppState appReducers(AppState state, dynamic action) {
  ...
  } else if(action is SetUserCourseUnits){
    return setUserCourseUnits(state, action);
  }
  return state;
}
...
AppState setUserCourseUnits(AppState state, SetUserCourseUnits action) {
  Logger().i('setting user course unit(s) ' + action.courseUnits.toString());
  return state.cloneAndUpdateValue('userCourseUnits', action.courseUnits);
}
