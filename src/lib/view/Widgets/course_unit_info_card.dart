...
class CUnitInfoCard extends GenericCard {
  CUnitInfoCard({Key key, this.courseUnit, this.courseUnitState});

  final CourseUnit courseUnit;
  final String courseUnitState;
        ...
        children: [
          TableRow(children: [
            ...
            Container(
              ...
              child: getInfoText(courseUnit.curricularYear.toString(), context),
            )
          ]),
          TableRow(children: [
            Container(
            ...
            Container(
              ...
              child: getInfoText(courseUnitState, context),
            )
          ]),
          TableRow(children: [
            Container(
            ...
            Container(
                ...
                child: getInfoText(
                    courseUnit.semesterName +
                        '/' +
                        (courseUnit.curricularYear + 1).toString(),
                    context))
          ]),
        ]);
  }
